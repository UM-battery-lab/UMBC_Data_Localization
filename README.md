...
Use the file src/updatedb.py, in this line you can specify device id and start time of the test record you want to update. Or you can leave the parameter empty, it will update all the database.
```
